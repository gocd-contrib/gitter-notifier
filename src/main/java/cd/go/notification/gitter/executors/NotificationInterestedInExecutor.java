...
public class NotificationInterestedInExecutor implements RequestExecutor {
    ...
    public GoPluginApiResponse execute() throws Exception {
        Map responseData = singletonMap("notifications", Collections.singletonList(Request.REQUEST_STAGE_STATUS.requestName()));
        return new DefaultGoPluginApiResponse(200, GSON.toJson(responseData));
    }
}
